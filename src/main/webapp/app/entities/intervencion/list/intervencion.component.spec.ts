...
describe('Intervencion Management Component', () => {
  let comp: IntervencionComponent;
  let fixture: ComponentFixture<IntervencionComponent>;
  let service: IntervencionService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'intervencion', component: IntervencionComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(IntervencionComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.intervencions?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
